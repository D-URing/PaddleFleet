...
Builds a GPT model with VHA attention layers. Combines layer spec
construction and model building in one place.
"""
...
def _get_vha_layer_spec(config, layer_number=1, attn_mask_type=AttnMaskType.causal):
